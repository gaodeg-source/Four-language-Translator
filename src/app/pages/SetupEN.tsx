...
export function SetupEN() {
  ...
  const targetLang = direction.targetLang || 'en';
    ...
    <div className="min-h-screen px-6 py-8" style={{ backgroundColor: '#FFFBF5' }}>
      ...
      <div className="max-w-lg space-y-10">
        ...
        <div>
          ...
          <Input
            type="text"
            placeholder="Enter a chat name (e.g., Business, Casual, etc.)"
            value={chatName}
